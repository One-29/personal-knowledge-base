...
| 版本 | v0.4 |
| 日期 | 2026-09-15 |
| 上游 | `01-requirements.md`（PRD v0.4）· `02-modules.md`（v0.3）· `03-data-model.md`（v0.3，DDL 使用 `chunks.embedding vector(1024)`） |
| 变更 | v0.4：记录默认 embedding 已迁移为 BAAI/bge-m3 / 1024 维；v0.3：补充切块连续性、索引查询与运行边界；v0.2：DR1–DR6 拍板 |
